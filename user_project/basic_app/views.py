...
@login_required
def special(request):
    HttpResponse("The Special message is nee sema da")
...
def user_login(request):
    if request.method == 'POST':
        ...
        if user:
            ...
            print("Someone tried with incorrect credentials")
            print("Username: {} and password: {} was used".format(username,password))
